...
export class NameItem extends Item {
  constructor(options: {}) {
    ...
    this.draw = (context: any, globalObj: GlobalEnv) => {
      ...
      context.fillText('ETECSA', this.x, this.y)
    }
  }
}
...
export class PlayerItem extends Item {
  constructor(options: {}) {
    ...
    this.draw = (context: any, globalObj: GlobalEnv) => {
      ...
      context.textAlign = 'center left'
      context.textBaseline = 'middle'

      context.fillText('ETECSA', this.x + 20, this.y)
...
export class NpcItem extends Item {
  constructor(options: {}) {
    ...
    this.draw = (context: any, globalObj: GlobalEnv) => {
      ...
      context.fillText('SALARIO', this.x + 20, this.y)
      let isSick = false
      if (this.status === 3) {
...
export class OverItem extends Item {
  constructor(options: {}) {
    ...
    this.draw = (context: any, globalObj: GlobalEnv) => {
      ...
      context.textAlign = 'center'
      context.textBaseline = 'middle'
      context.fillText(globalObj.LIFE ? 'WIN! RECARGA DEL EXTERIOR' : 'WIN! RECARGA DEL EXTERIOR', this.x, this.y)
    }
  }
}
